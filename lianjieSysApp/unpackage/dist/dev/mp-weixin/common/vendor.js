...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"恋家环保师傅端","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 5 */
/*!***************************************************************************************!*\
  !*** D:/Aijava/javaproject/260422/Solo Coder作业/lianjiaSysv3/lianjieSysApp/pages.json ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 18 */
/*!****************************************************************************************************!*\
  !*** D:/Aijava/javaproject/260422/Solo Coder作业/lianjiaSysv3/lianjieSysApp/common/data/mockData.js ***!
  \****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.orderList = exports.addressList = exports.currentUser = exports.userList = exports.familyList = exports.packageCardList = exports.packageList = exports.packageTags = exports.caseList = exports.bannerList = void 0; // 模拟数据
...
// 案例展示数据
exports.bannerList = bannerList;var caseList = [
{
  id: 1,
...
// 套餐标签数据
exports.caseList = caseList;var packageTags = [
{ id: 1, name: '日常清洁', icon: '🧹' },
{ id: 2, name: '深度清洁', icon: '✨' },
{ id: 3, name: '厨房清洁', icon: '🍳' },
...
// 套餐数据
exports.packageTags = packageTags;var packageList = [
{
  id: 1,
  name: '日常清洁套餐',
  price: 99,
...
// 套餐卡数据
exports.packageList = packageList;var packageCardList = [
{
  id: 1,
  cardNo: 'LJ2024001',
  name: '黄金会员卡',
...
// 家庭档案数据
exports.packageCardList = packageCardList;var familyList = [
{
  id: 1,
  userId: 1,
  name: '张先生家',
...
// 用户数据
exports.familyList = familyList;var userList = [
{
  id: 1,
  openId: 'o123456789',
  name: '张三',
...
// 当前登录用户数据
exports.userList = userList;var currentUser = {
  id: 1,
  openId: 'o123456789',
  name: '张师傅',
  phone: '13800138001',
...
// 地址数据
exports.currentUser = currentUser;var addressList = [
{
  id: 1,
  userId: 1,
  name: '张先生',
...
// 服务单数据
exports.addressList = addressList;var orderList = [
{
  id: 1,
...

{
  ...
  statusText: '已取消',
  price: 129,
  createTime: '2024-04-25 15:20:00' }];exports.orderList = orderList;

/***/ }),
/* 19 */
/*!******************************************************************************************************!*\
  !*** D:/Aijava/javaproject/260422/Solo Coder作业/lianjiaSysv3/lianjieSysApp/common/utils/navigator.js ***!
  \******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; // tabBar 页面路径（必须使用 switchTab）
var tabBarPages = [
'/pages/index/index',
...
/**
                                      * 智能导航函数
                                      * @param {string} keyOrPath - 页面键名或完整路径
                                      * @param {object} params - 页面参数（可选）
                                      */
function navigateTo(keyOrPath) {var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var url = pagePaths[keyOrPath] || keyOrPath;
  ...
  // 判断是否为 tabBar 页面
  var isTabBar = tabBarPages.some(function (tabPage) {return url.startsWith(tabPage);});

  if (isTabBar) {
    // tabBar 页面必须使用 switchTab
    console.log('使用 switchTab 跳转到 tabBar 页面');
    uni.switchTab({
      url: url.split('?')[0], // switchTab 不支持传参
    ...
    // 普通页面使用 navigateTo
    console.log('使用 navigateTo 跳转到普通页面');
    uni.navigateTo({
      url: url,
      success: function success() {
...
/**
   ...
   */
function navigateBack() {var delta = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
  var pages = getCurrentPages();
...

{
  ...
  pagePaths: pagePaths };exports.default = _default;
